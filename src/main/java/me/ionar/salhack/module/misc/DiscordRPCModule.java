...
public class DiscordRPCModule extends Module
{
    ...
    public final Value<Boolean> HOT___TOPIC = new Value<Boolean>("HOT___TOPIC", new String[] {"HT"}, "Displays a message about HOT___TOPIC", true);
    ...
    public final Value<Boolean> GitHub = new Value<Boolean>("GitHub", new String[] {"U"}, "Displays the github link(disabled since I do not have a github for this)", false);
    ...
    public String generateState()
    {
        ...
        if (HOT___TOPIC.getValue())
        {
            return "Playing with hot topic thing";
        }
        ...
        if (Crystalling.getValue() && _autoCrystal.isEnabled() && _autoCrystal.getTarget() != null)
            return "Crystalling " + _autoCrystal.getTarget() + "!";
