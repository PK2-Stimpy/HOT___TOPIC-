...
public class HoleFillerModule extends Module
{
    ...
    public final Value<Boolean> CobWeb = new Value<Boolean>("CobWeb", new String[] {"CW"}, "Place CobWebs instead of obsidian.", false);
    ...
    private Listener<EventPlayerMotionUpdate> OnPlayerUpdate = new Listener<>(p_Event ->
    {
        ...
        final int slot = findStackHotbar(CobWeb.getValue() ? Blocks.WEB : Blocks.OBSIDIAN);
    ...
    {
        if (!slotEqualsBlock(p_LastSlot, CobWeb.getValue() ? Blocks.WEB : Blocks.OBSIDIAN))
        {
    ...
    private Hole.HoleTypes isBlockValid(IBlockState blockState, BlockPos blockPos)
    {
        ...
        for (BlockPos touching : touchingBlocks)
        {
            ...
            if ((touchingState.getBlock() != Blocks.AIR) && touchingState.isFullBlock())
            {
                ...
                if (!l_Bedrock)
                {
                    if (touchingState.getBlock() != (CobWeb.getValue() ? Blocks.WEB : Blocks.OBSIDIAN) && touchingState.getBlock() != Blocks.BEDROCK)
                        l_Obsidian = false;
                }
            }
        }
